...
1. For each pair of variables, how would you describe the relationship graphically?
  ...
  **There are no interesting /odd features**
...
6. Compare your 3-D scatterplot and the `GGally::ggpairs` output.
  ...
  **If i push the code to github it does not display but it will display if i push the knitted version of the R code.**
...
It looks like every region is included into the model which is interesting.. I think it would be a bit difficult to interpret. 
